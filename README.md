### About
This fork contains minor changes to the scripts in the [upstream repo](https://github.com/ikekonglp/TweeboParser) to run on Python 3. 

Note that currently changes are **not** backwards compatible (2021-05-24).
